# 1 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c"
...
# 1 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c" 2
...
# 2 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c" 2
...
# 3 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c" 2
...
vuser_init()
{
	...
	lr_end_transaction("a02_Login",2);

	lr_think_time(5);

	return 0;
}
# 4 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c" 2
...
Action()
{
	...
	lr_end_transaction("b02s01_FlightSearch",2);
	...
	web_submit_form("mercurypurchase.php", 
		"Snapshot=t14.inf", 
		"ITEMDATA", 
		"Name=outFlight", "Value={p_outFlight}", "ENDITEM",  
		"Name=inFlight", "Value={p_inFlight}", "ENDITEM",  
		"Name=reserveFlights.x", "Value=60", "ENDITEM", 
		"Name=reserveFlights.y", "Value=7", "ENDITEM", 
		"LAST");

	lr_end_transaction("b02s02_FlightSelect",2);
	...
	lr_end_transaction("b02s03_FlightBook",2);
	...
	lr_end_transaction("b02s04_BacktoFlights",2);

	lr_think_time(5);

	return 0;
}
# 5 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c" 2
...
vuser_end()
{
	...
	lr_end_transaction("z01_SignOff",2);

	lr_think_time(1);

		return 0;
}
# 6 "z:\\github\\lr-pc-srl-scripts.git\\newtours_tps\\nttps_02_bookflight\\\\combined_nttps_02_bookFlight.c" 2
