...
load.action("Action", async function () {
    ...
    const transaction01 = new load.Transaction("01_Home");
    transaction01.start();
    ...
    const transaction03 = new load.Transaction("03_Headphones");
    transaction03.start();
    ...
    const transaction04 = new load.Transaction("04_Tablets");
    transaction04.start();
    ...
    const transaction05 = new load.Transaction("05_Speakers");
    transaction05.start();
    ...
    const transaction06 = new load.Transaction("06_Mice");
    transaction06.start();
